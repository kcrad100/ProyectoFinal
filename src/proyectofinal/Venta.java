...
public class Venta implements Serializable {
    ...
    private int cantProdVenta;
    private float valorTotalVenta;
    private boolean habilitado;

    public Venta(String consecutivo, String fecha, String idCliente, String codProducto, int cantidad, float valorTotal) { // Objeto de tipo Venta
